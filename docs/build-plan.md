...
| ------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------- | ----------------------------------------------- |
| `/`                 | Hero (visually-hidden h1 "Ahmed Sozzer — Full Stack Engineer"; the tagline "I write the layer most people import." as a real `<p>`, not hidden from screen readers), contents anchors, `#projects` (3 rows), `#experience`, `#education`, `#toolkit`, footer ("Open to full-time roles.") | ProfilePage + Person + WebSite                       | Name-first title                                |
...
- `/`: "Ahmed Sozzer — Full Stack Engineer · Austin, TX"
